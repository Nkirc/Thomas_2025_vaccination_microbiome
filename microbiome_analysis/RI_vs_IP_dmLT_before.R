...
write.csv(abund, "results/Before_Vaccination/RI_vs_IP_dmLT_before/taxonomy/genus/csvs/RI_vs_IP_dmLT_before_abundance.csv")

pdf("results/RI_vs_IP_dmLT_before/taxonomy/genus/plots/pcoa/RI_vs_IP_dmLT_before.pdf", onefile = TRUE, width = 10, height = 8)
# PCoA
...
write.csv(bray_curtis_pcoa_df, "results/Before_Vaccination/RI_vs_IP_dmLT_before/taxonomy/genus/csvs/RI_vs_IP_dmLT_before_pcoa.csv")
...
write.csv(pval.df, "results/RI_vs_IP_dmLT_before/taxonomy/genus/pvalues/beta_diversity/RI_vs_IP_dmLT_before.csv")
...
write.csv(kdf.ord, "results/RI_vs_IP_dmLT_before/taxonomy/genus/pvalues/diff_comparisons/RI_vs_IP_dmLT_before.csv")
...
#all groups boxplots
pdf("results/RI_vs_IP_dmLT_before/taxonomy/genus/plots/box_plots/RI_vs_IP_dmLT_before.pdf", onefile = TRUE, width = 10, height = 7)
...
write.csv(combo, "results/Before_Vaccination/RI_vs_IP_dmLT_before/taxonomy/genus/csvs/RI_vs_IP_dmLT_before_alpha_div.csv")

pdf("results/RI_vs_IP_dmLT_before/taxonomy/genus/plots/box_plots/RI_vs_IP_dmLT_before_alpha_diversity.pdf", onefile = TRUE, width = 10, height = 7)
