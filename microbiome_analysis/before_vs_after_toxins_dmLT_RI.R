...
ids <- meta$Mouse_ID[which(meta$Formula == "toxins_dmLT")]
pt6 <- pt6[,which(colnames(pt6) %in% ids)]
meta <- meta[which(meta$Mouse_ID %in% ids),]
...
write.csv(abund, "results/RI_Administration/before_vs_after_toxins_dmLT_RI/taxonomy/genus/csvs/before_vs_after_toxins_dmLT_RI_abundance.csv")

svg("results/before_vs_after_toxins_dmLT_RI/taxonomy/genus/plots/pcoa/before_vs_after_toxins_dmLT_RI.svg", onefile = TRUE, width = 10, height = 8)
# PCoA
...
write.csv(bray_curtis_pcoa_df, "results/RI_Administration/before_vs_after_toxins_dmLT_RI/taxonomy/genus/csvs/before_vs_after_toxins_dmLT_RI_pcoa.csv")
...
write.csv(pval.df, "results/before_vs_after_toxins_dmLT_RI/taxonomy/genus/pvalues/beta_diversity/before_vs_after_toxins_dmLT_RI.csv")
...
write.csv(kdf.ord, "results/before_vs_after_toxins_dmLT_RI/taxonomy/genus/pvalues/diff_comparisons/before_vs_after_toxins_dmLT_RI.csv")
...
#all groups boxplots
pdf("results/before_vs_after_toxins_dmLT_RI/taxonomy/genus/plots/box_plots/before_vs_after_toxins_dmLT_RI.pdf", onefile = TRUE, width = 10, height = 7)
...
write.csv(combo, "results/RI_Administration/before_vs_after_toxins_dmLT_RI/taxonomy/genus/csvs/before_vs_after_toxins_dmLT_RI_alpha_div.csv")

svg("results/before_vs_after_toxins_dmLT_RI/taxonomy/genus/plots/box_plots/before_vs_after_toxins_dmLT_RI_alpha_diversity.svg", onefile = TRUE, width = 10, height = 7)
