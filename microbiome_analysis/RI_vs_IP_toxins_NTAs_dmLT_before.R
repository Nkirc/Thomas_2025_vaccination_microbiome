...
ids <- meta$Mouse_ID[which(meta$Vaccination_Timing == "Before")]
pt6 <- pt6[,which(colnames(pt6) %in% ids)]
meta <- meta[which(meta$Mouse_ID %in% ids),]
...
write.csv(abund, "results/Before_Vaccination/RI_vs_IP_toxins_NTAs_dmLT_before/taxonomy/genus/csvs/RI_vs_IP_toxins_NTAs_dmLT_before_abundance.csv")

pdf("results/RI_vs_IP_toxins_NTAs_dmLT_before/taxonomy/genus/plots/pcoa/RI_vs_IP_toxins_NTAs_dmLT_before.pdf", onefile = TRUE, width = 10, height = 8)
# PCoA
...
write.csv(bray_curtis_pcoa_df, "results/Before_Vaccination/RI_vs_IP_toxins_NTAs_dmLT_before/taxonomy/genus/csvs/RI_vs_IP_toxins_NTAs_dmLT_before_pcoa.csv")
...
write.csv(combo, "results/Before_Vaccination/RI_vs_IP_toxins_NTAs_dmLT_before/taxonomy/genus/csvs/RI_vs_IP_toxins_NTAs_dmLT_before_alpha_div.csv")
