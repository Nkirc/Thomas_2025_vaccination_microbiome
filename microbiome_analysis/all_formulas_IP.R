...
ids <- meta$Mouse_ID[which(meta$Route == "IP")]
pt6 <- pt6[,which(colnames(pt6) %in% ids)]
meta <- meta[which(meta$Mouse_ID %in% ids),]
...
write.csv(abund, "results/IP_Administration/all_formulas_IP/taxonomy/genus/csvs/all_formuals_IP_abundance.csv")

svg("results/all_formulas_IP/taxonomy/genus/plots/pcoa/all_formuals_IP.svg", onefile = TRUE, width = 10, height = 8)
# PCoA
...
write.csv(bray_curtis_pcoa_df, "results/IP_Administration/all_formulas_IP/taxonomy/genus/csvs/all_formuals_IP_pcoa.csv")
...
write.csv(pval.df, "results/all_formulas_IP/taxonomy/genus/pvalues/beta_diversity/all_formulas_IP.csv")
...
write.csv(kdf.ord, "results/all_formulas_IP/taxonomy/genus/pvalues/diff_comparisons/all_formulas_IP.csv")
...
#all groups boxplots
pdf("results/all_formulas_IP/taxonomy/genus/plots/box_plots/all_formulas_IP.pdf", onefile = TRUE, width = 10, height = 7)
...
write.csv(combo, "results/IP_Administration/all_formulas_IP/taxonomy/genus/csvs/all_formuals_IP_alpha_div.csv")

svg("results/all_formulas_IP/taxonomy/genus/plots/box_plots/all_formulas_IP_alpha_diversity.svg", onefile = TRUE, width = 10, height = 7)
...
write.csv(whole, "results/all_formulas_IP/taxonomy/genus/pvalues/diff_comparisons/all_formulas_IP_alpha_diversity_dunn.csv")
