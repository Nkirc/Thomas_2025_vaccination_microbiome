...
svg("results/before_vs_after_dmLT_IP/taxonomy/genus/plots/pcoa/before_vs_after_dmLT_IP.svg", onefile = TRUE, width = 10, height = 8)
# PCoA
...
write.csv(pval.df, "results/before_vs_after_dmLT_IP/taxonomy/genus/pvalues/beta_diversity/before_vs_after_dmLT_IP.csv")
...
write.csv(kdf.ord, "results/before_vs_after_dmLT_IP/taxonomy/genus/pvalues/diff_comparisons/before_vs_after_dmLT_IP.csv")
...
#all groups boxplots
pdf("results/before_vs_after_dmLT_IP/taxonomy/genus/plots/box_plots/before_vs_after_dmLT_IP.pdf", onefile = TRUE, width = 10, height = 7)
...
svg("results/before_vs_after_dmLT_IP/taxonomy/genus/plots/box_plots/before_vs_after_dmLT_IP_alpha_diversity.svg", onefile = TRUE, width = 10, height = 7)
