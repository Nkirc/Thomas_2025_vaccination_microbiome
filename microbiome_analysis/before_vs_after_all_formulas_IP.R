...
write.csv(abund, "results/IP_Administration/before_vs_after_all_formulas_IP/taxonomy/genus/csvs/before_vs_after_all_formulas_IP_abundance.csv")

svg("results/before_vs_after_all_formulas_IP/taxonomy/genus/plots/pcoa/before_vs_after_all_formulas_IP.svg", onefile = TRUE, width = 10, height = 8)
# PCoA
...
write.csv(bray_curtis_pcoa_df, "results/IP_Administration/before_vs_after_all_formulas_IP/taxonomy/genus/csvs/before_vs_after_all_formulas_IP_pcoa.csv")
...
write.csv(pval.df, "results/before_vs_after_all_formulas_IP/taxonomy/genus/pvalues/beta_diversity/before_vs_after_all_formulas_IP.csv")
...
write.csv(kdf.ord, "results/before_vs_after_all_formulas_IP/taxonomy/genus/pvalues/diff_comparisons/before_vs_after_all_formulas_IP.csv")
...
#all groups boxplots
pdf("results/before_vs_after_all_formulas_IP/taxonomy/genus/plots/box_plots/before_vs_after_all_formulas_IP.pdf", onefile = TRUE, width = 10, height = 7)
...
write.csv(combo, "results/IP_Administration/before_vs_after_all_formulas_IP/taxonomy/genus/csvs/before_vs_after_all_formulas_IP_alpha_div.csv")

svg("results/before_vs_after_all_formulas_IP/taxonomy/genus/plots/box_plots/before_vs_after_all_formulas_IP_alpha_diversity.svg", onefile = TRUE, width = 10, height = 7)
