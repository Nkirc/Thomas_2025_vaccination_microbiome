...
write.csv(abund, "results/After_Vaccination/RI_vs_IP_all_formulas_after/taxonomy/genus/csvs/RI_vs_IP_all_formulas_after_abundance.csv")


svg("results/RI_vs_IP_all_formulas_after/taxonomy/genus/plots/pcoa/RI_vs_IP_all_formuals_after.svg", onefile = TRUE, width = 10, height = 8)
# PCoA
...
write.csv(bray_curtis_pcoa_df, "results/After_Vaccination/RI_vs_IP_all_formulas_after/taxonomy/genus/csvs/RI_vs_IP_all_formulas_after_pcoa.csv")
...
write.csv(pval.df, "results/RI_vs_IP_all_formulas_after/taxonomy/genus/pvalues/beta_diversity/RI_vs_IP_all_formulas_after.csv")
...
write.csv(kdf.ord, "results/RI_vs_IP_all_formulas_after/taxonomy/genus/pvalues/diff_comparisons/RI_vs_IP_all_formulas_after.csv")
...
#all groups boxplots
pdf("results/RI_vs_IP_all_formulas_after/taxonomy/genus/plots/box_plots/RI_vs_IP_all_formulas_after.pdf", onefile = TRUE, width = 10, height = 7)
...
write.csv(combo, "results/After_Vaccination/RI_vs_IP_all_formulas_after/taxonomy/genus/csvs/RI_vs_IP_all_formulas_after_alpha_div.csv")

svg("results/RI_vs_IP_all_formulas_after/taxonomy/genus/plots/box_plots/RI_vs_IP_all_formulas_after_alpha_diversity.svg", onefile = TRUE, width = 10, height = 7)
