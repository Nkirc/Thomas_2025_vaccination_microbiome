...
ids <- meta$Mouse_ID[which(meta$Route == "RI")]
pt6 <- pt6[,which(colnames(pt6) %in% ids)]
meta <- meta[which(meta$Mouse_ID %in% ids),]
...
write.csv(abund, "results/RI_Administration/all_formulas_RI/taxonomy/genus/csvs/all_formuals_RI_abundance.csv")

svg("results/all_formulas_RI/taxonomy/genus/plots/pcoa/all_formuals_RI.svg", onefile = TRUE, width = 10, height = 8)
# PCoA
...
write.csv(bray_curtis_pcoa_df, "results/RI_Administration/all_formulas_RI/taxonomy/genus/csvs/all_formuals_RI_pcoa.csv")
...
write.csv(pval.df, "results/all_formulas_RI/taxonomy/genus/pvalues/beta_diversity/all_formulas_RI.csv")
...
write.csv(kdf.ord, "results/all_formulas_RI/taxonomy/genus/pvalues/diff_comparisons/all_formulas_RI.csv")

#Dunn's test

pdf("results/all_formulas_before/taxonomy/genus/pvalues/diff_comparisons/all_formulas_before_dunn.pdf", onefile = TRUE, height = 10, width = 7)
...
#all groups boxplots
pdf("results/all_formulas_RI/taxonomy/genus/plots/box_plots/all_formulas_RI.pdf", onefile = TRUE, width = 10, height = 7)
...
write.csv(combo, "results/RI_Administration/all_formulas_RI/taxonomy/genus/csvs/all_formuals_RI_alpha_div.csv")

svg("results/all_formulas_RI/taxonomy/genus/plots/box_plots/all_formulas_RI_alpha_diversity.svg", onefile = TRUE, width = 10, height = 7)
...
write.csv(whole, "results/all_formulas_RI/taxonomy/genus/pvalues/diff_comparisons/all_formulas_RI_alpha_diversity_dunn.csv")
