...
svg("results/pcoa_IP_all_formulas_before_vs_after.svg", onefile = TRUE, width = 10, height = 8)
# PCoA
...
write.csv(bray_curtis_pcoa_df, "results/data_pcoa_IP_all_formulas_before_vs_after.csv")
...
# Creates a plot
plot <- ggplot(data = bray_curtis_pcoa_df, aes_string(x = "pcoa1", y = "pcoa2", color = "Group", shape = "Timing")) +
