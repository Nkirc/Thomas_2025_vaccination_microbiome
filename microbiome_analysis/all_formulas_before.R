...
svg("results/all_formulas_before/taxonomy/genus/plots/pcoa/all_formuals_before.svg", onefile = TRUE, width = 10, height = 8)
# PCoA
...
write.csv(pval.df, "results/all_formulas_before/taxonomy/genus/pvalues/beta_diversity/all_formulas_before.csv")
...
write.csv(kdf.ord, "results/all_formulas_before/taxonomy/genus/pvalues/diff_comparisons/all_formulas_before.csv")
...
#all groups boxplots
pdf("results/all_formulas_before/taxonomy/genus/plots/box_plots/all_formulas_before.pdf", onefile = TRUE, width = 10, height = 7)
...
svg("results/all_formulas_before/taxonomy/genus/plots/box_plots/all_formulas_before_alpha_diversity.svg", onefile = TRUE, width = 10, height = 7)
